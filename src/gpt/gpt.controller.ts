...
export class GptController {
  ...
  async getGeneratedImage(@Param('fileName') fileName: string) {
    console.log('generated/images/' + fileName);

    const filePath = await this.gptService.generatedImageGetter(fileName);
    return filePath;
  }
}
